...
export default function SingleUserPlantCard({
	plant, setPlants}: {plant: UsersPlant, setPlants: React.Dispatch<React.SetStateAction<UsersPlant[]>>}) {
	...
	return (
		<section className="my-plants">
			<ul className="my-plant-card">
				...
				<br></br>
				<button className="form" onClick={handleRemovePlantClick}>Remove plant</button>
